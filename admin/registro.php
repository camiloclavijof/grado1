    ...
    if(count($_POST) < 60){
      ...
      //print_r($_POST);
        try{
          ...
          $vereda = $_POST['vereda'];
          $cedula_cafetera =  !isset($_POST['cedula_cafetera']) ? '':  implode(',', $_POST['cedula_cafetera']);
          ...
          $afectacion_broca = !isset($_POST['afectacion_broca']) ? '':  implode(',', $_POST['afectacion_broca']);
          ...
          $disposicion_residuos = !isset($_POST['disposicion_residuos']) ? '':  implode(',', $_POST['disposicion_residuos']);
      ...
      $sql2 = "INSERT INTO datoscultivos (_2_ areas_sembradas , edad_cultivo, lote1, lote2, lote3, lote4, lote5, renovacion_nueva_siembra, renovacion_suca, cantidad_cargas, afectacion_broca, area_afectada, regional, foranea, jornales, disposicion_residuos, disposicion_residuos_cual, disposicion_envases, secadero, tiempo_construido, area_secadero, despulpadora, tiempo_uso, capacidad_despulpado, trilladora, area_almacenamiento_cafe, maquina_poscosecha, id_proyeccion) VALUES (_22_ '".$_POST["areas_sembradas"]."','".$_POST["edad_cultivo"]."','".$_POST["lote1"]."','".$_POST["lote2"]."','".$_POST["lote3"]."','".$_POST["lote4"]."','".$_POST["lote5"]."','".$_POST["renovacion_nueva_siembra"]."','".$_POST["renovacion_suca"]."','".$_POST["cantidad_cargas"]."', '".$afectacion_broca."', '".$_POST["area_afectada"]."', '".$_POST["regional"]."','".$_POST["foranea"]."','".$_POST["jornales"]."','".$disposicion_residuos."','".$_POST["disposicion_residuos_cual"]."','".$_POST["disposicion_envases"]."', '".$secadero."','".$_POST["tiempo_construido"]."','".$_POST["area_secadero"]."', '".$despulpadora."','".$_POST["tiempo_uso"]."','".$_POST["capacidad_despulpado"]."', '".$trilladora."', '".$_POST["area_almacenamiento_cafe"]."','".$_POST["maquina_poscosecha"]."','".$ultimoid."')";
      if($r){
        $sql2 = str_replace('_2_', 'id_datoscultivos,',$sql2);
      ...
      $sql3 = "INSERT INTO predios (_3_ nombrefinca, tenencia, vereda, georeferenciacion, tipo_acceso, id_datoscultivos) VALUES (_33_ '".$_POST["nombrefinca"]."', '".$tenencia."', '".$_POST["vereda"]."', '".$_POST["georeferenciacion"]."', '".$_POST["tipo_acceso"]."', '".$ultimoid2."')";
      if($r){
        $sql3 = str_replace('_3_', 'id_predios,',$sql3);
      ...
      $sql4 = "INSERT INTO nucleofamiliar (_4_ nombre_conyugue, primer_apellido, segundo_apellido, numero_documento, hijos, hijos_menores, hijos_mayores, personas_acargo, id_predios) VALUES (_44_ '".$_POST["nombre_conyugue"]."', '".$_POST["primer_apellido"]."', '".$_POST["segundo_apellido"]."', '".$_POST["numero_documento"]."', '".$_POST["hijos"]."', '".$_POST["hijos_menores"]."','".$_POST["hijos_mayores"]."','".$_POST["personas_acargo"]."', '".$ultimoid3."')";
        if($r){
          $sql4 = str_replace('_4_', 'id_nucleofamiliar,',$sql4);
      ...
      $sql5 = "INSERT INTO datospersonales (_5_ nombre, apellido1, apellido2, sexo, fecha_nacimiento, tipo_documento, numero_documento1, telefono, estado_civil, vereda, cedula_cafetera, correo_electronico, correo_electronico_name, id_nucleofamiliar) VALUES (_55_ '".$_POST["nombre"]."', '".$_POST["apellido1"]."','".$_POST["apellido2"]."', '".$sexo."', '".$_POST["fecha_nacimiento"]."', '".$tipo_documento."','".$_POST["numero_documento1"]."', '".$_POST["telefono"]."', '".$estado_civil."', '".$_POST["vereda"]."', '".$cedula_cafetera."', '".$correo_electronico."', '".$_POST["correo_electronico_name"]."', '".$ultimoid4."')";
      if($r){
        $sql5 = str_replace('_5_', 'id_datospersonales,',$sql5);
              ...
              <div class="col-xs-12 col-sm-12"> 
                  <div class="row">
                    ...
                    <div class="form-check col-md-6">
                      ...
                      <input type="radio"  name="cedula_cafetera[]" value="SI"/>SI
                      <input type="radio"  name="cedula_cafetera[]" value="NO"/>NO
                    </div>
                    <div class="form-check col-md-6">
            ...
            <div class="row setup-content" id="step-3">
              <div class="col-xs-12 col-sm-12">
                <div class="row">
                  ...
                  <div class="form-check col-md-6">
                    <label for="tenencia"  >Tenencia:</label><br>
                    <input type="radio"  name="tenencia[]" value="Propiedad"/>Propiedad
                    <input type="radio"  name="tenencia[]" value="Arriendo"/>Arriendo
                  </div>
                  <div class="form-group col-md-6">
            ...
            <div class="row setup-content" id="step-4">
              <div class="col-xs-12 col-sm-12">
                <div class="row">
                    ...
                    <input type="text"  name="areas_sembradas" class="form-control" placeholder="Digite el area sembrada">
                  </div>
                  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text"  name="renovacion_nueva_siembra" class="form-control" placeholder="Digite el area">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="renovacion_suca">Renovacion por suca en hectareas:</label>
                    <input type="text"  name="renovacion_suca" class="form-control" placeholder="Digite el area" >
                  </div>
                  <hr>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text"  name="cantidad_cargas" class="form-control" placeholder="Digite la cantidad de cargas" >
                  </div>
                  <div class="form-check col-md-4">
                      <label for="afectacion_broca" class="form-check-label" >Afectacion de broca:</label><br>
                      <input type="radio"  name="afectacion_broca[]" value="SI" />SI
                      <input type="radio"  name="afectacion_broca[]" value="NO"/>NO
                  </div>
                  <div class="form-group col-md-4">
                    <label for="area_afectada">Area afectada:</label>
                    <input type="text"  name="area_afectada" class="form-control" placeholder="Digite el area afectada" >
                  </div>
                  <hr>
                    <p>Mano de obra</p>
                  <hr>
                  ...
                  <div class="form-check col-md-4">
                    ...
                    <input type="radio"  name="disposicion_residuos[]" value="Compostaje"/>Compostaje
                    <input type="radio"  name="disposicion_residuos[]" value="Lombricultivo"/>Lombricultivo
                    <input type="radio"  name="disposicion_residuos[]" value="Otro"/>Otro
                  </div>
                  <div class="form-group col-md-4">
                    <label for="disposicion_residuos_cual">Cual:</label>
                    <input type="text"  name="disposicion_residuos_cual" class="form-control" placeholder="">
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-check col-md-2">
                    ...
                    <input type="radio" class="form-check-input" name="secadero[]" value="SI"/>SI
                    <input type="radio" class="form-check-input" name="secadero[]" value="NO"/>NO
                  </div>
                  ...
                  <div class="form-check col-md-2">
                    ...
                    <input type="radio"  name="despulpadora[]" value="SI"/>SI
                    <input type="radio"  name="despulpadora[]" value="NO"/>NO
                  </div>
                  <div class="form-group col-md-5">
                  ...
                  <div class="form-check col-md-2">
                    ...
                    <input type="radio"  name="trilladora[]" value="SI"/>SI
                    <input type="radio"  name="trilladora[]" value="NO"/>NO
                  </div>
