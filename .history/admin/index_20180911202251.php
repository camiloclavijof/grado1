                            ...
                            while($row = mysqli_fetch_assoc($run)){
                              echo '
                                 <tr>
                                    ...
                                    <td class="col-xs-1 delete"><form action="/grado/admin/exportExcel.php" method="post"><button type="submit" name="export_data" value="'.$row['id_datospersonales'].'" class="btn btn-info btn-sm pull-left">X</button></form></td>
                                </tr>
                                ';
                              }
                            ?>
