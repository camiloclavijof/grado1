...
$pdf->Image('../assets/img/firma.png', 'C', 180, 45, '', 'PNG', false, 'L', false, 300, 'C', false, false, 0, false, false, false);
$pdf->MultiCell(0, 10, 'DIRECCIÓN DE DESARROLLO AGROPECUARIO ECONÓMICO Y AMBIENTAL', 0, 'C', 0, 0, '', 200, true);
// $pdf->writeHTMLCell(0, 0, '', 200, $firma, 0, 1, 0, true, '', true);
