...
if( isset($_POST['Submit_form'])){
    if(count($_POST) < 60){
      ...
      //consultas sql
      $sql = "INSERT INTO proyeccion (_l_  ano1renovacion, ano2renovacion, ano3renovacion, ano4renovacion, ano5renovacion, ano1renovacionsuca, ano2renovacionsuca, ano3renovacionsuca, ano4renovacionsuca, ano5renovacionsuca ) VALUES (__l_ '".$_POST["ano1renovacion"]."','".$_POST["ano2renovacion"]."','".$_POST["ano3renovacion"]."','".$_POST["ano4renovacion"]."','".$_POST["ano5renovacion"]."','".$_POST["ano1renovacionsuca"]."','".$_POST["ano2renovacionsuca"]."','".$_POST["ano3renovacionsuca"]."','".$_POST["ano4renovacionsuca"]."','".$_POST["ano5renovacionsuca"]."')";
      if($r){
        $sql = str_replace('_l_', 'id_proyeccion,', $sql);
        $sql = str_replace('__l_', $_POST['id'].',', $sql);
      }else{
        $sql = str_replace('_l_', '', $sql);
        $sql = str_replace('__l_', $_POST['i';
      }
      ...
      $sql3 = "INSERT INTO predios (_3_ nombrefinca, tenencia, vereda, georeferenciacion, tipo_acceso, id_datoscultivos) VALUES (__3_ '".$_POST["nombrefinca"]."', '".$tenencia."', '".$_POST["vereda"]."', '".$_POST["georeferenciacion"]."', '".$_POST["tipo_acceso"]."', '".$ultimoid2."')";
      if($r){
        $sql3 = str_replace('_3_', 'id_predios,',$sql3);
        $sql3 = str_replace('__3_', $_POST['id'].',',$sql3);
      }else{
        $sql3 = str_replace('_3_', '',$sql3);
        $sql3 = str_replace('__3_', '',$sql3);
      }
      ...
      $sql4 = "INSERT INTO nucleofamiliar (_4_ nombre_conyugue, primer_apellido, segundo_apellido, numero_documento, hijos, hijos_menores, hijos_mayores, personas_acargo, id_predios) VALUES (__4_ '".$_POST["nombre_conyugue"]."', '".$_POST["primer_apellido"]."', '".$_POST["segundo_apellido"]."', '".$_POST["numero_documento"]."', '".$_POST["hijos"]."', '".$_POST["hijos_menores"]."','".$_POST["hijos_mayores"]."','".$_POST["personas_acargo"]."', '".$ultimoid3."')";
        if($r){
          $sql4 = str_replace('_4_', 'id_nucleofamiliar,',$sql4);
          $sql4 = str_replace('__4_', $_POST['id'].',',$sql4);
        }else{
          $sql4 = str_replace('_4_', '',$sql4);
          $sql4 = str_replace('__4_', '',$sql4);
        }
