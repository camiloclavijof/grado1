...
$html ="
    <p>El(a) señor(a) -nombres y apellidos de la persona- con numero de identificación -, se encuentra registrado en el sistema de Direccion de desarrollo agropecuario económico y ambiental.<br><br>
        Se expide el ".date('d/m/Y')." a las ".date("g:i:s A")." en Guayabetal Cundinamarca
    </p>
";
...
$pdf->Image('../assets/img/firma.png', 'C', 185, 45, '', 'PNG', false, 'L', false, 300, 'C', false, false, 0, false, false, false);
