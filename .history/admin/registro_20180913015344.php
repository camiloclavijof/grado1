    ...
    if(count($_POST) < 60){
      ...
      //print_r($_POST);
        try{
          ...
          $sexo = $_POST['sexo'] == NULL ? '':  implode(',', $_POST['sexo']);
          $fecha_nacimiento = strip_tags($_POST['fecha_nacimiento']);
          $tipo_documento = $_POST['tipo_documento'] == NULL ? '':  implode(',', $_POST['tipo_documento']);
          $numero_documento =  strip_tags($_POST['numero_documento']);
          $telefono = strip_tags($_POST['telefono']);
          $estado_civil = $_POST['estado_civil'];
          $vereda = $_POST['vereda'];
          $cedula_cafetera =  $_POST['cedula_cafetera'] == NULL ? '':  implode(',', $_POST['cedula_cafetera']);
          $correo_electronico = $_POST['correo_electronico'] == NULL ? '':  implode(',', $_POST['correo_electronico']);
          ...
          $tenencia = $_POST['tenencia'] == NULL ? '':  implode(',', $_POST['tenencia']);
          $vereda = $_POST['vereda'];
          ...
          $afectacion_broca = $_POST['afectacion_broca'] == NULL ? '':  implode(',', $_POST['afectacion_broca']);
          ...
          $disposicion_residuos = $_POST['disposicion_residuos'] == NULL ? '':  implode(',', $_POST['disposicion_residuos']);
  ...
  if(typeof datos != "undefined"){
    $.each(datos, function(index, value) {
      ...
      if(!a['length']){
        ...
        if($('form [name="'+index+'[]"]') && $('form [value="'+value+'"]').attr('type')  == "checkbox"){
