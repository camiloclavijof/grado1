    ...
    if(count($_POST) < 60){
      ...
      //print_r($_POST);
        try{
          ...
          $sexo = !$_POST['sexo'] ? '':  implode(',', $_POST['sexo']);
          $fecha_nacimiento = strip_tags($_POST['fecha_nacimiento']);
          $tipo_documento = !$_POST['tipo_documento'] ? '':  implode(',', $_POST['tipo_documento']);
          $numero_documento =  strip_tags($_POST['numero_documento']);
          $telefono = strip_tags($_POST['telefono']);
          $estado_civil = $_POST['estado_civil'];
          $vereda = $_POST['vereda'];
          $cedula_cafetera =  !$_POST['cedula_cafetera'] ? '':  implode(',', $_POST['cedula_cafetera']);
          $correo_electronico = !$_POST['correo_electronico'] ? '':  implode(',', $_POST['correo_electronico']);
          ...
          $tenencia = !$_POST['tenencia'] ? '':  implode(',', $_POST['tenencia']);
          $vereda = $_POST['vereda'];
          ...
          $afectacion_broca = !$_POST['afectacion_broca'] ? '':  implode(',', $_POST['afectacion_broca']);
          ...
          $disposicion_residuos = !$_POST['disposicion_residuos'] ? '':  implode(',', $_POST['disposicion_residuos']);
