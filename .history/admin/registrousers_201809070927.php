...
if(isset($_POST['registrar'])){
    ...
    if($UserName!='' &&$UserEmail!='' &&$UserPass !=''){
        ...
        $registro = mysqli_query($conn,"INSERT INTO users (UserId, UserName, UserEmail, role, UserPass) VALUES ('".$UserId."', '".$UserName."','".$UserEmail."', '".$role."','".$UserPass."')") or die(mysqli_error());
