...
$html ="
    <p>El(a) señor(a) ".$datos['nombre']." con numero de identificación -, se encuentra registrado en el sistema de Direccion de desarrollo agropecuario económico y ambiental.<br><br>
