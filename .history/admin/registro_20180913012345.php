...
if( isset($_POST['Submit_form'])){
    if(count($_POST) < 60){
      ...
      $sql3 = "INSERT INTO predios (id_predios nombrefinca, tenencia, vereda, georeferenciacion, tipo_acceso, id_datoscultivos) VALUES ('".$_POST["nombrefinca"]."', '".$tenencia."', '".$_POST["vereda"]."', '".$_POST["georeferenciacion"]."', '".$_POST["tipo_acceso"]."', '".$ultimoid2."')";
      if($r){
      ...
      $sql4 = "INSERT INTO nucleofamiliar (id_nucleofamiliar nombre_conyugue, primer_apellido, segundo_apellido, numero_documento, hijos, hijos_menores, hijos_mayores, personas_acargo, id_predios) VALUES ('".$_POST["nombre_conyugue"]."', '".$_POST["primer_apellido"]."', '".$_POST["segundo_apellido"]."', '".$_POST["numero_documento"]."', '".$_POST["hijos"]."', '".$_POST["hijos_menores"]."','".$_POST["hijos_mayores"]."','".$_POST["personas_acargo"]."', '".$ultimoid3."')";
        if($r){
      ...
      $sql5 = "INSERT INTO datospersonales (id_datospersonales nombre, apellido1, apellido2, sexo, fecha_nacimiento, tipo_documento, numero_documento, telefono, estado_civil, vereda, cedula_cafetera, correo_electronico, correo_electronico_name, id_nucleofamiliar) VALUES ('".$_POST["nombre"]."', '".$_POST["apellido1"]."','".$_POST["apellido2"]."', '".$sexo."', '".$_POST["fecha_nacimiento"]."', '".$tipo_documento."','".$_POST["numero_documento"]."', '".$_POST["telefono"]."', '".$estado_civil."', '".$_POST["vereda"]."', '".$cedula_cafetera."', '".$correo_electronico."', '".$_POST["correo_electronico_name"]."', '".$ultimoid4."')";
      if($r){
