                            ...
                            while($row = mysqli_fetch_assoc($run)){
                              echo '
                                 <tr>
                                    ...
                                    <td class="col-xs-1 editar"> <a href="registro.php?id="'.$row['id_datospersonales'].'">X</a></td>
                                    <td class="col-xs-1 delete" key="'.$row['id_datospersonales'].'"><i class="fa fa-pencil" aria-hidden="true"></i></td>
                                </tr>
                                ';
                              }
                            ?>
