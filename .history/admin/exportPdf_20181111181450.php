...
// Set some content to print
    ...
    // </div>
$empresa ="<h2>Direccion de desarrollo agropecuario económico y ambiental</h2>";
...
$pdf->writeHTMLCell(0, 0, '', 120, $empresa, 0, 1, 0, true, '', true);
$pdf->writeHTMLCell(0, 0, '', 120, $html, 0, 1, 0, true, '', true);
