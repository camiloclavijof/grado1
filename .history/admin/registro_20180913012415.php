...
if( isset($_POST['Submit_form'])){
    if(count($_POST) < 60){
      ...
      $sql3 = "INSERT INTO predios (_3_ nombrefinca, tenencia, vereda, georeferenciacion, tipo_acceso, id_datoscultivos) VALUES ('".$_POST["nombrefinca"]."', '".$tenencia."', '".$_POST["vereda"]."', '".$_POST["georeferenciacion"]."', '".$_POST["tipo_acceso"]."', '".$ultimoid2."')";
      if($r){
      ...
      $sql4 = "INSERT INTO nucleofamiliar (_4_ nombre_conyugue, primer_apellido, segundo_apellido, numero_documento, hijos, hijos_menores, hijos_mayores, personas_acargo, id_predios) VALUES ('".$_POST["nombre_conyugue"]."', '".$_POST["primer_apellido"]."', '".$_POST["segundo_apellido"]."', '".$_POST["numero_documento"]."', '".$_POST["hijos"]."', '".$_POST["hijos_menores"]."','".$_POST["hijos_mayores"]."','".$_POST["personas_acargo"]."', '".$ultimoid3."')";
        if($r){
